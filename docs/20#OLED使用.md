...
7.     Wr_I2C(0x78);      //Sla/e address,SA0=0
...
16.     OLED_WR_Byte(0xA6,OLED_CMD);//--normal / re/erse
...
22.     OLED_WR_Byte(0xD5,OLED_CMD);//set osc di/ision
...
30.     OLED_WR_Byte(0xDB,OLED_CMD);//set /comh
